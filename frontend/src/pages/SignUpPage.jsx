      ...
      <div className="flex flex-1 justify-center items-center p-8 lg:p-16">
        <div className="w-full max-w-md space-y-10 bg-card rounded-3xl shadow-xl p-10 animate-fadeIn">
          ...
          <div className="text-center space-y-3">
            ...
            <h1 className="text-3xl font-extrabold text-base-content">Create Account</h1>
            <p className="text-base-content/60">Sign up to join the conversation!</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control relative">
              ...
              <div className="relative w-full">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 text-base-content/40" />
                <input
                  type="text"
